<form id="app" wire:submit.prevent="submit" x-data="{ editor: $wire.entangle('editor')  }" class="w-full min-h-screen m-auto bg-gray-200">
    ...
    <!-- Cuerpo principal -->
    <section x-data="editor($el)" x-init="$watch('elements', elements => editor.elementos = elements )" class="sm:max-w-full md:max-w-xl mx-auto pb-40 pt-16">
        ...
        <div class="bg-white mb-10 p-3 grid grid-flow-row gap-2 shadow-md">
            ...
            <section class="grid gap-3 grid-cols-2">
                ...
                <input type="text" x-model="editor.titulo_corto" placeholder="Nombre corto" class="w-full bg-white text-xl rounded p-2 border focus:outline-none focus:border-blue-500 col-span-2" />
                <x-input-error for="editor.titulo_corto" />
                <input type="text" x-model="editor.titulo_largo" placeholder="Nombre largo" class="w-full bg-white rounded p-2 border focus:outline-none focus:border-blue-500 col-span-2" />
                <x-input-error for="editor.titulo_largo" />
                <textarea x-model="editor.descripcion" placeholder="Descripción" class="w-full bg-white rounded p-2 border focus:outline-none focus:border-blue-500 col-span-2"></textarea>
                <x-input-error for="editor.descripcion" />
            </section>
