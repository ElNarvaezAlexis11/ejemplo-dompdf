<div id="app" class="w-full min-h-screen m-auto bg-gray-200">
    <div class="sm:max-w-full md:max-w-xl mx-auto pb-40">
        <div class="">
            {{-- Seccion de informacion basica del anexo --}}
            <div class="bg-white mb-10 p-3 grid grid-flow-row gap-4 shadow-md">
                    ...
                    <div class="col-span-2">
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="p-2 border-b border-gray-300">{{$rowTitle}}</td>
